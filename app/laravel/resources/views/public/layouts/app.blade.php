...
@endif>
    ...
    <header
        class="w-full border-b border-white/15 relative z-10 overflow-hidden backdrop-blur"
        style="background-color: rgba(0, 0, 0, {{ $headerOpacity / 100 }});"
        data-animate
    ...
    >
        ...
        <div class="relative max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('home') }}"
                    class="text-sm text-white/90 underline underline-offset-4 transition-colors duration-200 hover:text-white interactive-surface">
                    Главная
                </a>
            </div>
        </div>
